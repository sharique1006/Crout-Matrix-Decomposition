...
Strategy2_N1 = [1.620, 1.618, 2.045, 2.038]
Strategy3_N1 = [1.641, 1.633, 2.152, 2.069]
Strategy4_N1 = [2.343, 1.812, 3.268]

N2 = 2000
Strategy1_N2 = [12.943, 8.933, 10.828, 11.849]
Strategy2_N2 = [13.188, 15.019, 21.018, 17.898]
Strategy3_N2 = [13.819, 13.535, 21.548, 18.054]
Strategy4_N2 = [18.985, 14.408, 12.790]

N3 = 3000
Strategy1_N3 = [46.153, 28.888, 37.945, 30.085]
Strategy2_N3 = [61.524, 64.513, 68.372, 63.935]
Strategy3_N3 = [59.510, 89.992, 113.025, 90.496]
Strategy4_N3 = [54.929, 40.202, 59.603]

N4 = 4000
Strategy1_N4 = [133.853, 72.189, 77.144, 79.706]
Strategy2_N4 = [132.167, 124.886, 181.654, 167.351]
Strategy3_N4 = [155.631, 180.614, 214.678, 179.242]
